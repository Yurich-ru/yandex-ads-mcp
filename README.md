...
**151 инструмент** для полного цикла управления рекламой из AI-ассистентов (Claude Code, Cursor, Windsurf и др.).

## Возможности

| Сервис | Инструментов | Что умеет |
|--------|-------------|-----------|
| **Яндекс Директ** | 85 | Кампании, группы, объявления, ключевики, ставки, корректировки, минус-фразы, быстрые ссылки, уточнения, визитки, фиды, изображения, видео, ретаргетинг, площадки, стратегии, отчёты |
...
| `yd_ads_get` | Получить текстовые и комбинаторные объявления, включая все заголовки и тексты |
...
`business_id`. Не смешивайте `responsive_ad` с полями старого текстового формата в одном объявлении.
